...
g_hat_ie=1.5; g_hat_ei=0; g_hat_ii=0; g_hat_ee=0;
%-----------------------------------
...
% deterministic drive:
I_e=@(t) 1.25*ones(num_e,1)+2.0*ones(num_e,1).*(sign(20.5-[1:num_e]')+1)/2;

% maximum conductance, decay time, and frequency of Poisson train of excitatory input pulses:
g_stoch_e=0.1; tau_d_stoch_e=3; f_stoch_e=20;
%-----------------------------------
...
% maximum conductance, decay time, and frequency of Poisson train of excitatory input pulses:
g_stoch_i=0.2; tau_d_stoch_i=1.5; f_stoch_i=38;
%-----------------------------------
